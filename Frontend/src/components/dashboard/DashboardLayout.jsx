...
export function DashboardLayout({ sidebarItems, children, title }) {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      ...
      <aside
        className={cn(
          "fixed lg:sticky top-16 left-0 z-50 h-[calc(100vh-4rem)] w-64 flex-shrink-0 border-r border-gray-200 bg-white transform transition-transform duration-200 ease-out lg:translate-x-0",
